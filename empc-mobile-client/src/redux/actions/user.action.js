...
export const SET_USER_ROLES_STATE = `${prefix} SET_USER_ROLES_STATE`;
...
export const CLEAR_USER_ROLES_STATE = `${prefix} CLEAR_USER_ROLES_STATE `;
...
export const set_user_roles_state = usrData => ({
  type: SET_USER_ROLES_STATE,
  payload: usrData,
});

export const clear_user_roles_state = usrData => ({
  type: CLEAR_USER_ROLES_STATE,
  payload: usrData,
});
